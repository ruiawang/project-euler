...
The partition function p(n), proven by Euler's pentagonal number theorem, can be expressed in terms of the partition functions of n - g_k where g_k is the kth generalized pentagonal number. We can cache these values when we compute them to speed up computation.
